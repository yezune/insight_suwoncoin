...
var home = process.env.INSIGHT_DB || (getUserHome() + '/.insight_suwoncoin');
...
if (!dataDir) {
  if (isWin) dataDir = '%APPDATA%\\Suwonin\\';
  if (isMac) dataDir = process.env.HOME + '/Library/Application Support/Suwoncoin/';
  if (isLinux) dataDir = process.env.HOME + '/.suwoncoin/';
}
...
//  p2pPort: process.env.BITCOIND_P2P_PORT || '9777',
